...
public class UserLoggingAspect {
	...
	@Around("execution(* com.grameenworld.service..*.*(..))")
	...
	@Around("execution(* com.grameenworld.controller..*.*(..))")
	...
	@Around("execution(* com.grameenworld.util..*.*(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.grameenworld.service..*.*(..))", throwing = "ex")
